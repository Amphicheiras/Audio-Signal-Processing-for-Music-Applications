...
def downloadSoundsFreesound(queryText = "clarinet", tag="single-note", duration=(1,8), API_Key = "LvoQBxhi6ZdKDLTGkDUtUkveuhPmYOfYuMP4UAB6", outputDir = "instruments", topNResults = 20, featureExt = '.json'):
  """
